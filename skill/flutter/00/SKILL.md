...
Cuando el usuario pida **crear**, **modificar** o **corregir** una feature, DEBES actualizar automáticamente la documentación SIN que el usuario lo pida explícitamente:

### Reglas obligatorias:

1. **Crear feature:** Crear `doc/<nombre-feature>/SPEC.md`, `ARCHITECTURE.md` y `TODO.md`
2. **Modificar feature:** Actualizar los archivos existentes en `doc/<nombre-feature>/`
3. **Corregir/corregir bug en feature:** Actualizar `TODO.md` y `SPEC.md` si es necesario
...
This is AUTOMATIC - do not ask the user to confirm.
